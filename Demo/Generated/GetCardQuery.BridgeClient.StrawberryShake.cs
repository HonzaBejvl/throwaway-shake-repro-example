...
namespace Logic.Graphql.Generated
{
    ...
    public partial class GetCardQuery : global::Logic.Graphql.Generated.IGetCardQuery
    {
        private readonly global::StrawberryShake.IOperationExecutor<IGetCardResult> _operationExecutor;
        ...
        public GetCardQuery(global::StrawberryShake.IOperationExecutor<IGetCardResult> operationExecutor, global::StrawberryShake.Serialization.ISerializerResolver serializerResolver)
        {
        ...
        global::System.Type global::StrawberryShake.IOperationRequestFactory.ResultType => typeof(IGetCardResult);
        public async global::System.Threading.Tasks.Task<global::StrawberryShake.IOperationResult<IGetCardResult>> ExecuteAsync(global::System.String id, global::Logic.Graphql.Generated.Currency currency, global::System.Threading.CancellationToken cancellationToken = default)
        {
            var request = CreateRequest(id, currency);
            return await _operationExecutor.ExecuteAsync(request, cancellationToken).ConfigureAwait(false);
        }

        public global::System.IObservable<global::StrawberryShake.IOperationResult<IGetCardResult>> Watch(global::System.String id, global::Logic.Graphql.Generated.Currency currency, global::StrawberryShake.ExecutionStrategy? strategy = null)
        {
            var request = CreateRequest(id, currency);
            return _operationExecutor.Watch(request, strategy);
        }

        private global::StrawberryShake.OperationRequest CreateRequest(global::System.String id, global::Logic.Graphql.Generated.Currency currency)
        {
        ...
        {
            return new global::StrawberryShake.OperationRequest(id: GetCardQueryDocument.Instance.Hash.Value, name: "GetCard", document: GetCardQueryDocument.Instance, strategy: global::StrawberryShake.RequestStrategy.Default, variables: variables);
        }
