...
namespace Logic.Graphql.Generated.State
{
    ...
    public partial class ListingAddResultFactory : global::StrawberryShake.IOperationResultDataFactory<global::Logic.Graphql.Generated.ListingAddResult>
    {
        private readonly global::StrawberryShake.IEntityStore _entityStore;
        public ListingAddResultFactory(global::StrawberryShake.IEntityStore entityStore)
        {
            _entityStore = entityStore ?? throw new global::System.ArgumentNullException(nameof(entityStore));
        }

        global::System.Type global::StrawberryShake.IOperationResultDataFactory.ResultType => typeof(global::Logic.Graphql.Generated.IListingAddResult);
        public ListingAddResult Create(global::StrawberryShake.IOperationResultDataInfo dataInfo, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            if (snapshot is null)
            {
            ...
            if (dataInfo is ListingAddResultInfo info)
            {
                return new ListingAddResult(MapNonNullableIListingAdd_ListingAdd(info.ListingAdd, snapshot));
            }

            throw new global::System.ArgumentException("ListingAddResultInfo expected.");
        }

        private global::Logic.Graphql.Generated.IListingAdd_ListingAdd MapNonNullableIListingAdd_ListingAdd(global::Logic.Graphql.Generated.State.ListingAddPayloadData data, global::StrawberryShake.IEntityStoreSnapshot snapshot)
        {
            IListingAdd_ListingAdd returnValue = default !;
            if (data.__typename.Equals("ListingAddPayload", global::System.StringComparison.Ordinal))
            {
                returnValue = new ListingAdd_ListingAdd_ListingAddPayload(MapNonNullableIListingAdd_ListingAdd_Result(data.Result ?? throw new global::System.ArgumentNullException(), snapshot));
            }
            else
            {
        ...
        private global::Logic.Graphql.Generated.IListingAdd_ListingAdd_Result MapNonNullableIListingAdd_ListingAdd_Result(global::Logic.Graphql.Generated.State.IListingData data, global::StrawberryShake.IEntityStoreSnapshot snapshot)
        {
            IListingAdd_ListingAdd_Result? returnValue;
            ...
            else if (data is global::Logic.Graphql.Generated.State.OfferData offer)
            {
                ...
                returnValue = new global::Logic.Graphql.Generated.ListingAdd_ListingAdd_Result_Offer(MapNonNullableIGetDetailAdmin_Listing_Price(offer.Price, snapshot), offer.ServiceType!.Value, MapNonNullableIGetDetailAdmin_Listing_Estate_1(offer.Estate, snapshot), MapNonNullableIGetDetailAdmin_Listing_Seller_1(offer.Seller, snapshot), offer.ListingId ?? throw new global::System.ArgumentNullException(), offer.Title, offer.Description, MapNonNullableIGetListingCards_Listings_Items_SlideshowNonNullableArray(offer.Slideshow, snapshot), MapNonNullableIGetListingCards_Listings_Items_PhotosNonNullableArray(offer.Photos, snapshot), MapNonNullableIGetDetail_Listing_VideosNonNullableArray(offer.Videos, snapshot), MapNonNullableIGetDetail_Listing_FloorPlansNonNullableArray(offer.FloorPlans, snapshot), offer.State!.Value, offer.Created!.Value, offer.Published, offer.Closed);
            }
