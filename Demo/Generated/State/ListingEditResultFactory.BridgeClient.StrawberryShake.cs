...
namespace Logic.Graphql.Generated.State
{
    ...
    public partial class ListingEditResultFactory : global::StrawberryShake.IOperationResultDataFactory<global::Logic.Graphql.Generated.ListingEditResult>
    {
        private readonly global::StrawberryShake.IEntityStore _entityStore;
        public ListingEditResultFactory(global::StrawberryShake.IEntityStore entityStore)
        {
            _entityStore = entityStore ?? throw new global::System.ArgumentNullException(nameof(entityStore));
        }

        global::System.Type global::StrawberryShake.IOperationResultDataFactory.ResultType => typeof(global::Logic.Graphql.Generated.IListingEditResult);
        public ListingEditResult Create(global::StrawberryShake.IOperationResultDataInfo dataInfo, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            if (snapshot is null)
            {
            ...
            if (dataInfo is ListingEditResultInfo info)
            {
                return new ListingEditResult(MapNonNullableIListingEdit_ListingEdit(info.ListingEdit, snapshot));
            }

            throw new global::System.ArgumentException("ListingEditResultInfo expected.");
        }

        private global::Logic.Graphql.Generated.IListingEdit_ListingEdit MapNonNullableIListingEdit_ListingEdit(global::Logic.Graphql.Generated.State.ListingEditPayloadData data, global::StrawberryShake.IEntityStoreSnapshot snapshot)
        {
            IListingEdit_ListingEdit returnValue = default !;
            if (data.__typename.Equals("ListingEditPayload", global::System.StringComparison.Ordinal))
            {
                returnValue = new ListingEdit_ListingEdit_ListingEditPayload(MapNonNullableIListingEdit_ListingEdit_Subject(data.Subject ?? throw new global::System.ArgumentNullException(), snapshot));
            }
            else
            {
        ...
        private global::Logic.Graphql.Generated.IListingEdit_ListingEdit_Subject MapNonNullableIListingEdit_ListingEdit_Subject(global::Logic.Graphql.Generated.State.IListingData data, global::StrawberryShake.IEntityStoreSnapshot snapshot)
        {
            IListingEdit_ListingEdit_Subject? returnValue;
            ...
            else if (data is global::Logic.Graphql.Generated.State.OfferData offer)
            {
                ...
                returnValue = new global::Logic.Graphql.Generated.ListingEdit_ListingEdit_Subject_Offer(MapNonNullableIGetDetailAdmin_Listing_Price(offer.Price, snapshot), offer.ServiceType!.Value, MapNonNullableIGetDetailAdmin_Listing_Estate_1(offer.Estate, snapshot), MapNonNullableIGetDetailAdmin_Listing_Seller_1(offer.Seller, snapshot), offer.ListingId ?? throw new global::System.ArgumentNullException(), offer.Title, offer.Description, MapNonNullableIGetListingCards_Listings_Items_SlideshowNonNullableArray(offer.Slideshow, snapshot), MapNonNullableIGetListingCards_Listings_Items_PhotosNonNullableArray(offer.Photos, snapshot), MapNonNullableIGetDetail_Listing_VideosNonNullableArray(offer.Videos, snapshot), MapNonNullableIGetDetail_Listing_FloorPlansNonNullableArray(offer.FloorPlans, snapshot), offer.State!.Value, offer.Created!.Value, offer.Published, offer.Closed);
            }
